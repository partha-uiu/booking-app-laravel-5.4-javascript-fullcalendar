    ...
    <div id="eventDetails" class="collapse show" data-parent="#bookings-accordion">
        <div class="card-body">
            <div class="form-group">
                ...
                <select class="form-control" name="time" id="time">
                    ...
                    @foreach(['day', 'night', 'fullday'] as $time )
                        <option
                                value="{{ $time }}"
                                @if(old('time', $booking->duration) == $time) selected @endif
                        >
                            {{ ucfirst($time) }}
                        </option>
                    @endforeach
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="event_type" id="event_type">
                    ...
                    @foreach($eventTypes as $eventType )
                        <option
                            value="{{$eventType->id}}"
                            @if(old('event_type', $booking->event_type_id) == $eventType->id) selected @endif
                        >
                            {{$eventType->name}}
                        </option>
                    @endforeach
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="guest_count" id="guest_count" value="{{ old('guest_count', $booking->guest_count) }}">
            </div>
        </div>
    </div>
</div>